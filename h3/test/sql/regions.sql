...
-- cells_to_multi_polygon initializes the native PostgreSQL polygon bounding box
SELECT box(exterior)
	~= box '(-143.77201562176984,50.21316388126197),(-145.20900978883313,49.268689394068176)'
FROM h3_cells_to_multi_polygon(ARRAY[:hexagon]);

-- h3_cells_to_multi_polygon skips NULL indexes instead of reading NULL Datum
SELECT COUNT(*) = 1
FROM h3_cells_to_multi_polygon(ARRAY[:hexagon, NULL::h3index]);
